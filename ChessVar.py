"""
============================================================
Project: Atomic Chess (Console)
Author: Kaitlyn Hill

Summary:
    Console-based Atomic Chess implementation with two classes:
      - Player: stores player name + color
      - ChessVar: manages board state, turn order, move validation,
                 atomic capture explosions, and win state.

Rules implemented:
    - Classic movement rules for pawns, rooks, knights, bishops, queens, kings
    - Atomic chess capture: capturing triggers an “explosion” that clears the
      captured square plus all adjacent squares (3x3 area).
    - Pawns are not removed by explosions unless they are on the capture square.
    - If a king is exploded, the opposing side wins.
============================================================
"""
